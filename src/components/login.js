        ...
        <Col className="mb-3">
          ...
          <Form.Group as={Col}>
            ...
            {failure && <div className="alert alert-danger" role="alert"
                             style={marginTop}>Käyttäjää ei löydy.</div>}
            {failure2 && <div className="alert alert-danger" role="alert"
                              style={marginTop}>Käyttäjätunnus tai salasana
              väärin.</div>}
            {success && <div className="alert alert-success" role="alert"
                             style={marginTop}>Kirjautuminen onnistui.</div>}
          </Form.Group>
        </Col>
